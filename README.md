...
- 🔹 Работает **без React** (чистый DOM API)
- 🔹 Поддержка **6 позиций**: `top-left`, `top-center`, `bottom-right` и др.
- 🔹 Готовые типы: `success`, `error`, `warning`, `default`
- 🔹 Кастомизация через CSS или динамические стили
- 🔹 Анимации появления/исчезновения
- 🔹 Поддержка TypeScript «из коробки»
- 🔹 Совместимость: React, Next.js, Vite, Webpack, Bun и др.
